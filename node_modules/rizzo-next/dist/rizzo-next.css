...
.lp-global-header__container--slim {
  max-width: 107rem;
}

.lp-global-header__container--narrow {
  max-width: 96rem;
}

.lp-global-header__container--half {
  max-width: 63rem;
}
...
.lp-global-header__logo svg {
  display: block;
  height: 100%;
  width: 100%;
}

.lp-global-header--narrow .lp-global-header__logo {
  fill: #287bbb;
}
...
.lp-global-header__search [class*="icon-"] {
  color: #fff;
  font-size: 2rem;
  margin-right: 1.2rem;
...
.lp-global-header__search:hover [class*="icon-"], .lp-global-header__search:active [class*="icon-"], .lp-global-header__search:focus [class*="icon-"] {
  margin-right: 0.9rem;
}
...
.lp-global-header--narrow .lp-global-header__search [class*="icon-"],
...
.lp-global-header__mobile-search::before, .lp-global-header__mobile-menu::before, .lp-global-header__mobile-cart::before {
  bottom: 0;
  display: block;
  font-size: 2.3rem;
  left: 0;
...
.lp-global-header__mobile-search {
  height: 5rem;
  width: 5rem;
}

.lp-global-header__mobile-search::before {
  margin-left: .4rem;
}

.lp-global-header__mobile-menu {
  height: 5rem;
  width: 5rem;
}
...
.lp-global-footer__logo:hover, .lp-global-footer__logo:active, .lp-global-footer__logo:focus {
  fill: #287bbb;
}

.lp-global-footer__logo svg {
  display: block;
  height: 4.6rem;
}
